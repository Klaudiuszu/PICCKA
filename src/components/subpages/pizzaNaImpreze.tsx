    ...
    >
      <div className="max-w-screen-2xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-4">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <Heading>{tString("pizzaNaImpreze.header")}</Heading>
          <p className="text-textDark text-lg">{tString("pizzaNaImpreze.p1")}</p>
          <p className="text-textDark text-lg">
            {tString("pizzaNaImpreze.p2")}{" "}
            <a
...
export default PizzaNaImprezeSection;
